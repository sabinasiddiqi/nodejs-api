...
sed '1s/DRG Definition/drg_def/' Provider_Summary.csv > temp.csv
...
mongoimport --db master --collection providers --type csv --headerline --file temp.csv

echo imported data from new file into mongodb <db> rest_test <collection> providers
